  ...
  <v-form v-model="withinMax" class="v-container">
    ...
    <v-card>
      <v-card-title class="v-row">
        ...
        <v-number-input v-model.number="len" label="Word Length" class="v-col-3 offset-6" />
      </v-card-title>
      <v-divider/>
      <v-card-item>
        <v-row>
          <v-text-field v-model.trim="beg" label="Beginning Letters" :error-messages="errors" :maxlength="len+beg.length-count" class="v-col-4" append-inner-icon="mdi-arrow-expand-right" />
          <v-text-field v-model.trim="mid" label="Middle Letters"    :error-messages="errors" :maxlength="len+mid.length-count" class="v-col-4" append-inner-icon="mdi-arrow-expand-horizontal" />
          <v-text-field v-model.trim="end" label="Ending Letters"    :error-messages="errors" :maxlength="len+end.length-count" class="v-col-3" prepend-inner-icon="mdi-arrow-expand-left" />
